(function (_, Kotlin, $module$kotlin_css_js, $module$styled_components, $module$kotlin_extensions, $module$inline_style_prefixer, $module$kotlin_react, $module$kotlin_react_dom, $module$react, $module$react_dom, $module$kotlinx_html_js) {
  ...
  function animation_0($receiver, duration, timing, delay, iterationCount, direction, fillMode, playState, handler) {
    ...
    var keyframe = invoke(StyledComponents.keyframes, string, []);
    injectGlobal(StyledComponents, invoke_0(StyledComponents.css, [keyframe]));
  ...
  var keyframes = defineInlineFunction('kotlin-styled.styled.keyframes_sizrkg$', wrapFunction(function () {
    ...
    var injectGlobal = _.styled.injectGlobal_8rxfql$;
  ...
  StyleSheet.prototype.inject = function () {
    if (!this.isLoaded_1mk3xi$_0 && this.isStatic) {
      ...
      injectGlobal($module$styled_components, builder.toString());
    }
  };
  StyleSheet.$metadata$ = {
    kind: Kind_CLASS,
  ...
  var keyframesName = defineInlineFunction('kotlin-styled.styled.keyframesName_8rxfql$', wrapFunction(function () {
    var invoke = _.$$importsForInline$$['kotlin-extensions'].kotlinext.js.invoke_dgimx$;
    var invoke_0 = _.$$importsForInline$$['kotlin-extensions'].kotlinext.js.invoke_9p99ed$;
    var injectGlobal = _.styled.injectGlobal_8rxfql$;
    return function ($receiver, string) {
      var keyframe = invoke($receiver.keyframes, string, []);
      injectGlobal($receiver, invoke_0($receiver.css, [keyframe]));
      return keyframe.getName();
    };
  }));
  ...
  function injectGlobal($receiver, string) {
    var tmp$, tmp$_0;
    var globalStyleComponent = invoke($receiver.createGlobalStyle, string, []);
    ...
    var obj = {};
    var reactElement = createElement(globalStyleComponent, obj);
    Promise.resolve(Unit).then(injectGlobal$lambda(reactElement, element));
  }
  function injectGlobal_0($receiver, handler) {
    var $receiver_0 = new CSSBuilder();
    handler($receiver_0);
    injectGlobal($module$styled_components, $receiver_0.toString());
  }
  function Styled() {
  ...
  Styled.prototype.wrap_0 = function (type) {
    ...
    if (value == null) {
      var answer = invoke_0($module$styled_components.default(type), [Styled$wrap$lambda$lambda]);
  ...
  package$styled.keyframesName_8rxfql$ = keyframesName;
  ...
  package$styled.injectGlobal_8rxfql$ = injectGlobal;
  package$styled.injectGlobal_47v0k2$ = injectGlobal_0;
